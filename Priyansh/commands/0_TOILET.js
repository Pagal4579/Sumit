...
module.exports.onLoad = async() => {
    ...
    const path = resolve(__dirname, 'cache', 'toilet.jpeg');
...
async function makeImage({ one, two }) {
    ...
    let hon_img = await jimp.read(__root + "/toilet.jpeg");
    let pathImg = __root + `/toilet_${one}_${two}.jpeg`;
    ...
    let raw = await hon_img.getBufferAsync("image/jpeg");
